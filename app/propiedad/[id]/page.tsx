            ...
            <div className="sticky top-[156px] space-y-5">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="flex gap-2">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://penalvainmobiliaria.com.ar/propiedad/${property.id}`)}`}
                  ...
                  <a
                    href={`https://wa.me/?text=${encodeURIComponent(`Mirá esta propiedad: https://penalvainmobiliaria.com.ar/propiedad/${property.id}`)}`}
                    target="_blank" rel="noopener noreferrer"
                  ...
                  <CopyLinkButton url={`https://penalvainmobiliaria.com.ar/propiedad/${property.id}`} />
                </div>
              </div>
